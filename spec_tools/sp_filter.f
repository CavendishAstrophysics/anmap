...
C   flag to indicate taking various fliters of data
       logical    fil_abs, fil_log, fil_ln, fil_exp
C   counters
       integer    n, nc
C Functions
       integer    chr_lenb
...
C .. parameters used to scale
       ...
       call cmd_itemset( 'abs', fil_abs, status )
       call cmd_itemset( 'log', fil_log, status )
       call cmd_itemset( 'ln', fil_ln, status )
       call cmd_itemset( 'exp', fil_exp, status )
