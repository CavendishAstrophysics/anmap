*+ PGISOM
      ...
      SUBROUTINE PGISOM(ARRAY,KX,NY,SIZE,ANGLE,SMIN,SMAX)
      INTEGER KX, NY
      REAL ARRAY(KX,NY), SIZE, ANGLE, SMIN, SMAX
C
...
C
      ...
      LOGICAL VISBLE
      COMMON /PGISOM1/ DELTAX,X,STEP,LEFT,RIGHT,IT,NX,VISBLE
C
      MN = KX*NY
      NX = KX
C     Check array size:
