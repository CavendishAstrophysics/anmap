...
C local redtape variables
     ...
     *                 local_tscope
       ...
       option_list(22)= 'astrometric-header'
...
C decode option
     ...
     *               local_obsdat,txt_input,status)
       ...
       elseif (chr_cmatch(option,'astrometric-header')) then
         call enmapc(local_ramap,local_decmap,local_refdat,
     *               local_obsdat,txt_input,status)
         call io_getra('Map-centre RA  : ','*',local_ramap,
     *               status)
         call io_getdec('Map-centre DEC : ','*',local_decmap,
     *               status)
